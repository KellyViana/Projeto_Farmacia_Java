...
/* esse name = MBFornecedores é pra poder conseguir chamar ele no html*/
...
public void novo() { 
	...
	public void excluir(){
		try {
			...
			JSFUtil.adicionarMensagemErro("Não é possível excluir fornecedor que tem um produto associado");
			e.printStackTrace();
